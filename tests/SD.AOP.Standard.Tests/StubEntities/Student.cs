using SD.AOP.Standard.Aspects.ForMethod;
using SD.AOP.Standard.Attributes;
using SD.AOP.Standard.Tests.StubImplements;
using System;

namespace SD.AOP.Standard.Tests.StubEntities
{
    /// <summary>
    /// 学生
    /// </summary>
