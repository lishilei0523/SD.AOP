...
using SD.AOP.Standard.Models.ValueObjects;
using System;
using System.Collections.Generic;
using System.Reflection;
using System.Text;

namespace SD.AOP.Standard.Toolkits
{
    /// <summary>
    /// 日志建造者
    /// </summary>
    internal static class LogBuilder
    {
        ...
        public static void BuildExceptionInfo(this ExceptionLog log, MethodExecutionArgs eventArgs)
        {
            ...
            log.InnerException = LogBuilder.BuildInnerException(exceptionBuilder, eventArgs.Exception);
        }
        #endregion
